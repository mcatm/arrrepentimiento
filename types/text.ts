...
export type TextLine = TextLineParagraph | TextLineImage | TextLineList | TextLineLink | TextLineWork | TextLineDelimiter | TextLineYoutube;

export type TextLineParagraph = string | {
