...
export default {
  head () {
    return {
      title: 'Works - Arrepentimiento',
      meta: [
        { hid: 'description', name: 'description', content: 'The Works made by Arrepentimiento.' },
        { hid: 'og:description', name: 'og:description', content: 'The Works made by Arrepentimiento.' }
      ]
    }
  },
};
