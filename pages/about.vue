...
export default {
  head () {
    return {
      title: 'About - Arrepentimiento',
      meta: [
        { hid: 'description', name: 'description', content: 'About Arrepentimiento.' },
        { hid: 'og:description', name: 'og:description', content: 'About Arrepentimiento.' }
      ]
    }
  },
};
