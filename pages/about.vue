    ...
    <div class="l-main">
      <div class="l-hero">
        <div class="copy">
          <p>
            <em
              >In the burnt red-black sky, the gospel resonates in capital
              HELVETICA.</em
            ><br />
          ...
          <p>
            <em
              >At the beach where the sadness ended, preparations for a new
              party begin.</em
            ><br />
          ...
          <p>
            <em
              >Buildings of sound constructed in fictitious dimensions are now
              irradiated to the body from completely different angles.</em
            ><br />
            架空の次元で構築された音の建造物が、今まさに全く別の角度から肉体に照射された。
          </p>
          <p>
            <em
              >A melody is born like breathing, and rhythm dies as if to breathe
              out.</em
            ><br />
          ...
          <p>
            <em
              >Let's say goodbye to old-fashioned magic. At the entrance of the
              mellow cavity era.</em
            ><br />
      ...
      <div class="l-columns reverse">
        <div class="column">
          <p class="en">
            <strong
              >We build the modern folk songs by home-recording. The
              miscellaneous members give them special bodies by the experimental
              methods that ignore any contexts and add strange atmosphere.
              Between confusion and silence.</strong
            >
          </p>
          <p class="ja">
            <small
              >実験音楽とモダンフォークの光輝なる融合。知る人ぞ知るエディットサイケバンドdrawing4-5を母体とするコレクティブ「Arrrepentimiento（アレペンティミエント）」。日本語で「後悔」。雑多なメンバーが入れ替わり立ち替わり参加したり離れたりしながら、コンテキストを無視した演奏と奇怪な音像で、断片的なメロディに実体を与えていく事故音楽。ノイズ〜コラージュといった実験音楽と、リリカルなフォークソングの厳かな融合が、一瞬の儀式のように駆け抜けていきます。</small
            >
          </p>
        </div>
        <div class="column">
